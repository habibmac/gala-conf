...
const handleselectEvent = (newEventId: string) => {
  router.push({ name: "Event", params: { eventId: newEventId } });
};
  ...
  <Popover v-model:open="open">
      <PopoverTrigger as-child>
        <Button
          ...
          :class="cn(
            'sm:min-w-80 md:w-96 relative h-12 justify-start text-left font-normal',
        ...
        >
          ...
          <div
            v-else-if="event"
            class="flex w-full items-center justify-between space-x-1 pr-10"
          >
