		...
		<div class="h-full px-4 sm:px-6 lg:px-8">
			<div class="-mb-px flex h-full items-center justify-between">
				...
				<div class="flex h-full">
                    ...
                    <NuxtLink v-else to="/events" class="text-sm font-medium text-muted-foreground transition-colors hover:text-primary"><Logo class="mt-2 h-10 w-10 fill-white" /></NuxtLink>
				...
				<div class="flex h-16 items-center space-x-1">
					...
					<!-- Divider -->
					<hr
						class="h-6 w-px border-none bg-slate-200 dark:bg-slate-700"
					/>
