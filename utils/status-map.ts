...
export const allTransStatuses: StatusConfig[] = [
  ...
  },
  {
    ...
    badgeClass: 'border-amber-500 text-amber-700 bg-amber-50 dark:border-amber-400 dark:text-amber-300 dark:bg-amber-950/20',
    pillClass: 'bg-amber-600 text-white dark:bg-amber-500 dark:text-white',
